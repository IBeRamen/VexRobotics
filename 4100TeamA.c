...
#pragma config(Motor,  port6,           shooter1,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           shooter2,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           shooter3,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           shooter4,      tmotorVex393HighSpeed_MC29, openLoop)
